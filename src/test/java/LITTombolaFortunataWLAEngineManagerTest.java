...
public class LITTombolaFortunataWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITTombolaFortunataWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITTombolaFortunataWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITTombolaFortunataWLAIW/InitOutcome.xml").getDocumentElement();
